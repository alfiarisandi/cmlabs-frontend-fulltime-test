    ...
    <div>
        ...
        <div className='px-3 header'>
            ...
            <div className='container d-flex flex-row mt-5 gap-2 breadcrumb'>
                ...
                <span>{' > '}</span>
                <span onClick={() => navigate('/meals/'+ingredients)}>{ingredients}</span>
                <span>{' > '}</span>
                <span className='fw-semibold'>{detailMeals?.strMeal}</span>
            </div>

            <div className='container'>
                <h3 className='text-center fw-bold mt-2 mb-4'>{detailMeals?.strMeal}</h3>
            </div>
        ...
        <div className='container mt-4 gap-5 detail-content'>
            ...
            <div className='content-left'>
                <span className='fw-bold text-warning mb-3'>{detailMeals?.strArea} Culinary</span>
